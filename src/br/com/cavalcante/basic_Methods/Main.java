...
public class Main {
    ...
    public static void myMethods(){
        ...
        System.out.println("------------------------ Call a Method 1 ------------------------------------------------------------------------------------------------------------");
    ...
    public static void myMethod_2(){
        System.out.println("------------------------ Call a Method 2 ------------------------------------------------------------------------------------------------------------");
    }

    public static void myMethod_3(){
        System.out.println("------------------------ Call a Method 3 ------------------------------------------------------------------------------------------------------------");
    }
}
